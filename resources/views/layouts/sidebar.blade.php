<div class="main-sidebar">
	<aside id="sidebar-wrapper">
		...
		<ul class="sidebar-menu">
			...
			<li><a class="nav-link" href="{{route('users')}}"><i class="fas fa-users"></i> <span>Data Pengguna</span></a></li>
			<li><a class="nav-link" href="{{route('lokasi.rapat')}}"><i class="fas fa-location-pin"></i> <span>Data Lokasi Rapat</span></a></li>
			<li><a class="nav-link" href="{{route('jenis.rapat')}}"><i class="fas fa-tablet"></i> <span>Data Jenis Rapat</span></a></li>
			@endif
