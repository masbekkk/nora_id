...
@section('modal')
    <div class="modal fade" id="NotulensiDetailModal" tabindex="-1" role="dialog" aria-labelledby="NotulensiDetailModalLabel"
        aria-hidden="true">
                ...
                <div class="modal-body text-dark">
                    <table class="table w-100 table-sm table-borderless">
                        ...
                        <tr class="pt-2">
                            ...
                            <td id="mdata-file-notulensi"><a class="btn btn-success h-100"
                                    href="{{ route('download.notulensi', ['id' => '1']) }}"><i
                                        class="fa-solid fa-arrow-down-to-square"></i> Download File</a></td>
                        </tr>
                    </table>
                </div>
            </div>
                                        ...
                                        <td class="d-flex justify-content-center">
                                            <div class="row w-100">
                                                <div class="col-12 d-flex justify-content-between">
                                                    @if ($a->notulen_id == Auth::user()->id)
                                                        <a class="btn btn-primary btn-sm text-white w-50 mr-1"
                                                            href="{{ route('edit.notulensi', ['id' => $a->id]) }}"
                                                            title="Edit"><i class="fas fa-edit"></i></a>
                                                        <a class="btn btn-danger btn-sm text-white w-50 ml-1"
                                                            href="{{ route('delete.notulensi', ['id' => $a->id]) }}"
                                                ...
                                                <div class="col-12 d-flex justify-content-center mt-2">
                                                    <a class="btn btn-info w-50 mr-1 btn-sm text-white" title="Detail"
                                                        data-toggle="modal" data-target="#NotulensiDetailModal"
                                                    ...
                                                    <a class="btn btn-success w-50 ml-1 btn-sm text-white"
                                                        href="{{ route('download.notulensi', $a->id) }}"
                                                        title="Download"><i class="fas fa-circle-arrow-down"></i></a>
                                                </div>
                                            </div>
                                        </td>
                                        ...
                                        <td class="d-flex justify-content-center">
                                            <div class="row w-100">
                                                <div class="col-12 d-flex justify-content-between">
                                                    ...
                                                    <a class="btn btn-primary w-100 btn-sm text-white" title="Detail"
                                                        data-toggle="modal" data-target="#NotulensiDetailModal"
                                                        data-no-undangan="{{ $a->no_undangan }}"
                                                        data-tgl="{{ $a->tgl->format('d F Y') }}"
                                                        data-lokasi="{{ $a->lokasi }}"
                                                    ...
                                                    <a class="btn btn-info btn-sm text-white w-50 ml-1"
                                                        href="{{ route('download.notulensi', ['id' => $a->id]) }}"><i
